"""
Django settings for dj_money project.
...
WSGI_APPLICATION = 'dj_money.wsgi.application'
...
DOWNLOAD_API_TOKEN = env('DOWNLOAD_API_TOKEN')
YANDEX_ACCESS_KEY = env('YANDEX_ACCESS_KEY')
